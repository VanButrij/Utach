package com.gpd.utach.database
...
import com.gpd.utach.utilits.AppValueEventListener
import com.gpd.utach.utilits.TYPE_GROUP
...
class AppDatabase {
    ...
    companion object {
        ...
        fun sendMessage(message: String, receivingUserID: String, typeText: String, function: () -> Unit) {
            ...
            mapMessage[CHILD_IS_READ] = false
        ...
        fun setMessageRead(id: String, from: String) {

            REF_DATABASE_ROOT.child(NODE_MESSAGES).child(CURRENT_UID).child(from)
                .child(id).child(CHILD_IS_READ).setValue(true)
                .addOnSuccessListener {
                    REF_DATABASE_ROOT.child(NODE_MESSAGES).child(from).child(CURRENT_UID)
                        .child(id).child(CHILD_IS_READ).setValue(true)
        ...
        fun uploadFileToStorage(
            ...
            val path: StorageReference = REF_STORAGE_ROOT.child(FOLDER_FILES).child(messageKey)
        ...
        fun sendMessageAsFile(
            ...
            val mapMessage = hashMapOf<String, Any>()
            mapMessage[CHILD_FROM] = CURRENT_UID
            mapMessage[CHILD_TO] = CURRENT_UID
